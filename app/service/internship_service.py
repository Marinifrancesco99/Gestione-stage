...
class InternshipService:
    ...
    def get_by_student(student_id):
        ...
        if not internship:
            raise ValueError(f"No internships found for student ID {student_id}.")
        return internship
    ...
    def get_by_company(company_id):
        ...
        if not internship:
            raise ValueError(f"No internships found for company ID {company_id}.")
        return internship
    ...
    def get_by_tutor(tutor_id):
        ...
        if not internship:
            raise ValueError(f"No internships found for tutor ID {tutor_id}.")
        return internship
    ...
    def get_by_status(status):
        ...
        if not internship:
            raise ValueError(f"No internships found for status {status}.")
        return internship
    ...
    def get_by_date_range(start_date, end_date):
        ...
        if not internship:
            raise ValueError("No internship in range.")
        return internship