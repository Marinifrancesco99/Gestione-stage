...
class InterviewsService:
    ...
    def update_interview(interview_id, date=None, result=None, notes=None, company_id=None, student_id=None):
        ...
        if not interview:
            raise NotFoundException(f"No interview found for interview id {interview_id}.")
    ...
    def get_interviews_by_student(student_id):
        ...
        if not interviews:
            raise NotFoundException(f"No interviews found for student id {student_id}.")
        return interviews
    ...
    def get_interviews_by_company(company_id):
        ...
        if not interviews:
            raise NotFoundException(f"No interviews found for company id {company_id}.")
        return interviews
    ...
    def get_interviews_by_date(date):
        ...
        if not interviews:
            raise NotFoundException(f"No interviews found for date {date}.")
        return interviews
    ...
    def get_by_result(result_text):
        ...
        if not interviews:
            raise NotFoundException(f"No interviews found with result {result_text}.")
        return interviews